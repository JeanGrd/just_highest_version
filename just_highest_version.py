...
Remark : This code allows to keep the highest version from a list
where version is located in a text box with separators, in my case,
the separator is '_' but you can put whatever you want.
